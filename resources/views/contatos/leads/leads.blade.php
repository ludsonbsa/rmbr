...
<section class="content" style="">
    ...
    <div class="tabs-content">
        ...
        <div class="tab1 tabs first-tab">
            <div class="widget">
                <div class="content" ng-controller="Contatos">
                    ...
                    <table id="myTable" border="0" width="100" >
                        ...
                        <tr class="hits" ng-repeat="hit in hits">
                            <td ng-bind-html="hit._highlightResult.nome.value"></td>
                            <td ng-bind-html="hit._highlightResult.telefone.value"></td>
                            <td ng-bind-html="hit._highlightResult.email.value"></td>
                            <td ng-bind-html="hit._highlightResult.insercao_hotmart.value"></td>
                            <td ng-bind-html="hit._highlightResult.prioridade.value"></td>
                            <td ng-bind-html="hit._highlightResult.responsavel.value"></td>
                            <td ng-bind-html="hit._highlightResult.aprovado.value"></td>
                        </tr>
    ...
    angular.module('AlgoliaApp', ['ngSanitize'])
        ...
        .controller('Contatos',function($scope, Contatos){
            $scope.listar = function(){
                Contatos.listar().success(function(data){
                    $scope.contatos = data;
                });
            };
            $scope.hits = [];
